...
<body>
	...
	<%-- 				<li class="nav-item"><a class="nav-link" name="tabs1"
					href="javascript:void(0)" data="/getArticlListByChannelId?cid=${c.id }">全部</a></li>
		
		 --%>
			<c:forEach items="${list }" var="c">
				<li class="nav-item"><a class="nav-link" name="tabs1"
					href="javascript:void(0)" data="/getArticlListByCategoryId?cid=${c.id }">${c.name }</a></li>
			</c:forEach>
		</ul>
       ...
       <!-- 默认显示该栏目下的所有文章 -->
		<div id="defaultContent">
			...
			<div class="media">
				<img class="align-self-start mr-1" src="/pic/${c.picture }" alt="no pic">
